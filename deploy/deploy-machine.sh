...
# Set OPENCODE_RUN_USER=<service-user> when OpenCode should run as a regular user.
...
OPENCODE_FIRST_DATA_TIMEOUT_MS=${OPENCODE_FIRST_DATA_TIMEOUT_MS:-900000}
OPENCODE_EVENT_CONNECT_TIMEOUT_MS=${OPENCODE_EVENT_CONNECT_TIMEOUT_MS:-15000}
OPENCODE_TOOL_BRIDGE_POOL_SIZE=${OPENCODE_TOOL_BRIDGE_POOL_SIZE:-8}
OPENCODE_TOOL_BRIDGE_ACQUIRE_TIMEOUT_MS=${OPENCODE_TOOL_BRIDGE_ACQUIRE_TIMEOUT_MS:-10000}
OPENCODE_SESSION_TTL_MS=${OPENCODE_SESSION_TTL_MS:-1800000}
OPENCODE_SESSION_MAX_ENTRIES=${OPENCODE_SESSION_MAX_ENTRIES:-1000}
EOF
fi
chmod 600 "$ENV_FILE"
